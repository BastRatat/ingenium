...
export const ChannelsConfigSchema = z.object({
  whatsapp: WhatsAppConfigSchema.optional().transform((v) =>
    WhatsAppConfigSchema.parse(v ?? {})
  ),
  telegram: TelegramConfigSchema.optional().transform((v) =>
    TelegramConfigSchema.parse(v ?? {})
  ),
});
...
export const AgentsConfigSchema = z.object({
  defaults: AgentDefaultsSchema.optional().transform((v) =>
    AgentDefaultsSchema.parse(v ?? {})
  ),
});
...
export const ProvidersConfigSchema = z.object({
  anthropic: ProviderConfigSchema.optional().transform((v) =>
    ProviderConfigSchema.parse(v ?? {})
  ),
  openai: ProviderConfigSchema.optional().transform((v) =>
    ProviderConfigSchema.parse(v ?? {})
  ),
  openrouter: ProviderConfigSchema.optional().transform((v) =>
    ProviderConfigSchema.parse(v ?? {})
  ),
  groq: ProviderConfigSchema.optional().transform((v) =>
    ProviderConfigSchema.parse(v ?? {})
  ),
  zhipu: ProviderConfigSchema.optional().transform((v) =>
    ProviderConfigSchema.parse(v ?? {})
  ),
  vllm: ProviderConfigSchema.optional().transform((v) =>
    ProviderConfigSchema.parse(v ?? {})
  ),
  gemini: ProviderConfigSchema.optional().transform((v) =>
    ProviderConfigSchema.parse(v ?? {})
  ),
});
...
export const WebToolsConfigSchema = z.object({
  search: WebSearchConfigSchema.optional().transform((v) =>
    WebSearchConfigSchema.parse(v ?? {})
  ),
});
...
export const ToolsConfigSchema = z.object({
  web: WebToolsConfigSchema.optional().transform((v) =>
    WebToolsConfigSchema.parse(v ?? {})
  ),
});
...
export const ConfigSchema = z.object({
  ...
  channels: ChannelsConfigSchema.optional().transform((v) =>
    ChannelsConfigSchema.parse(v ?? {})
  ),
  providers: ProvidersConfigSchema.optional().transform((v) =>
    ProvidersConfigSchema.parse(v ?? {})
  ),
  gateway: GatewayConfigSchema.optional().transform((v) =>
    GatewayConfigSchema.parse(v ?? {})
  ),
  tools: ToolsConfigSchema.optional().transform((v) =>
    ToolsConfigSchema.parse(v ?? {})
  ),
});
